...
val_url='https://www.kicker.de/premier-league/spieltag/2021-22/1'

if val_url:
    url = 'https://www.kicker.de/premier-league/spieltag/2021-22/1'
    ...
    for j in range (len(value)):
        if len(value[j].find('div.kick__v100-gameList__header'))>0:
            ...
            if len(date_val)>0:
                if value[j].find('div.kick__v100-gameList__header')[0].text== date_val[0]:
                    ...
                    for i in range (len(val22)):
                        ...
                        val_text=val1.replace("spielbericht","aufstellung")     
                        val_text2=val_text.replace("schema","aufstellung")
                        list_val1.append(val_text2)           
                        all_url.append(val_text2)   
                    for i in range (len(teamA)):
                        val_te=teamA[i].text
                        list_val1.append(val_te)
                        all_value.append(val_te)
            ...
            if len(date_val)>1 and len(all_value)<20:
                    ...
                    if value[j].find('div.kick__v100-gameList__header')[0].text== date_val[1]:
                        ...
                        for i in range (len(val23)):
                            ...
                            val_text=val2.replace("spielbericht","aufstellung")
                            val_text2=val_text.replace("schema","aufstellung")
                            list_val.append(val_text2)
            ...
            if len(date_val)>2 and len(all_value)<20:
            ...
            if len(date_val)>3  and len(all_value)<20:
                ...
                if value[j].find('div.kick__v100-gameList__header')[0].text== date_val[3]: 
                    ...
                    for i in range (len(val23)):
                        ...
                        val_text=val3.replace("spielbericht","aufstellung")
                        val_text2=val_text.replace("schema","aufstellung")
                        list_val3.append(val_text2)
                        all_url.append(val_text2)    
            ...
            if len(date_val)>4  and len(all_value)<20:
            ...
            if len(date_val)>5 and len(all_value)<20:
            ...
            if len(date_val)>6  and len(all_value)<20:
            ...
            if len(date_val)>7  and len(all_value)<20:
            ...
            if len(date_val)>8 and len(all_value)<20:
...
list_dict=(dict_val.values())
ten=all_url[:10]
val_url2=list_val1

if val_url2 ==list_val1: 
   
    for q in range (len(all_url)):
        ...
        if len(list(dict_val.keys()))>8:
            for i in dict_val[list(dict_val.keys())[8]]: 
                if home_team[0].text in i:
                    dict_res['Datum'].append(list(dict_val.keys())[8])      
        ...
        if len(away_yelname) >1:
            df_res['away_yellowcard2']=away_yelname[1]
        if len(away_yelname) >2:
            df_res['away_yellowcard3']=away_yelname[2]
        if len(away_yelname) >3:
            df_res['away_yellowcard4']=away_yelname[3]
        if len(away_yelname) >4:
            df_res['away_yellowcard5']=away_yelname[4]
        if len(away_yelname) >5:
            df_res['away_yellowcard6']=away_yelname[5]
        if len(away_yelname) >6:
            df_res['away_yellowcard7']=away_yelname[6]
        if len(away_yelname) >7:
            df_res['away_yellowcard8']=away_yelname[7]
        if len(away_yelname) >8:
            df_res['away_yellowcard9']=away_yelname[8]
        if len(away_yelname) >9:
            df_res['away_yellowcard10']=away_yelname[9]
        if len(away_yelname) >10:
            df_res['away_yellowcard11']=away_yelname[10]
        if len(away_yelname) >11:
            df_res['away_yellowcard12']=away_yelname[11]
        if len(away_yelname) >12:
            df_res['away_yellowcard13']=away_yelname[12]


        #update away time
        if len(away_yeltime) >1:
            df_res['away_yellowcard_time2']=away_yeltime[1]
        if len(away_yeltime) >2:
            df_res['away_yellowcard_time3']=away_yeltime[2]
        if len(away_yeltime) >3:
            df_res['away_yellowcard_time4']=away_yeltime[3]
        if len(away_yeltime) >4:
            df_res['away_yellowcard_time5']=away_yeltime[4]
        if len(away_yeltime) >5:
            df_res['away_yellowcard_time6']=away_yeltime[5]
        if len(away_yeltime) >6:
            df_res['away_yellowcard_time7']=away_yeltime[6]
        if len(away_yeltime) >7:
            df_res['away_yellowcard_time8']=away_yeltime[7]
        if len(away_yeltime) >8:
            df_res['away_yellowcard_time9']=away_yeltime[8]
        if len(away_yeltime) >9:
            df_res['away_yellowcard_time10']=away_yeltime[9]
        if len(away_yeltime) >10:
            df_res['away_yellowcard_time11']=away_yeltime[10]
        if len(away_yeltime) >11:
            df_res['away_yellowcard_time12']=away_yeltime[11]
        if len(away_yeltime) >12:
            df_res['away_yellowcard_time13']=away_yeltime[12]    



        #update home red card player
        if len(home_red_value)>1:
            dict_res['redcard2']=home_red_value[1]
        if len(home_red_value)>2:
            dict_res['redcard3']=home_red_value[2]
            
        #udpate home red card time
        if len(home_red_value1)>1:
            dict_res['redcard_time2']=home_red_value1[1] 
        if len(home_red_value1)>2:
            dict_res['redcard_time3']=home_red_value1[2] 
            
        #update away red card player

        if len(away_cardname)>1:
            dict_res['away_redcard_time2']=away_cardname[1]
        if len(away_cardname)>2:
            dict_res['away_redcard_time3']=away_cardname[2]
            # dict_res['away_redcard1'].append(away_red_value1[1])

        #update away red card player time
        if len(away_cardtime)>1:
            dict_res['away_redcard2']=away_cardtime[1]

        if len(away_cardtime)>2:
            dict_res['away_redcard3']=away_cardtime[2]
             
        if q==0:
            print("enter")
            df_res.to_csv('scrap11999.csv',mode='a', header=True)
        else:
            print("enter3")
            df_res.to_csv('scrap11999.csv',mode='a', header=False)
